...
\section{Education}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      {Integrated Masters Degree In Computer Science}{University of Surrey}{Sep 2023 -- Jun 2026 (Expected)}{\small{Finished first year on the Dean's list with a 1st - 82\% average}}
...
\section{Skills}
 \begin{itemize}[leftmargin=0pt, label={}]
    \small{\item{
     Java, JavaScript, ExpressJS, ReactJS, C, C++, Python, Django, SQL, NoSQL, Neo4j, Git, CI/CD, Docker, Linux
    }}
 \end{itemize}
